...
path = '/content/drive/My Drive/xAPI-Edu-Data.csv'
data = pd.read_csv('/content/drive/My Drive/xAPI-Edu-Data.csv')
for i in range (1, 17):
...
path = '/content/drive/My Drive/Data_lab02/creditcard.csv'
df = pd.read_csv(path)
# missing values
